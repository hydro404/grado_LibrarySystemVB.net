...
Public Class view_returned
    ...
    Private Sub view_returned_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim connStr As String = "server=localhost;user=root;database=book_reservation;port=3306;password=@Hydrogn10;"
        conn = New MySqlConnection(connStr)
        Dim da As New MySqlDataAdapter("SELECT * FROM return_logs", conn)
    ...
    Private Sub view_returned_Closed(sender As Object, e As EventArgs) Handles Me.Closed
